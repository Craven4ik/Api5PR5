            ...
            (
                    ...
                    requestBody = @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Пример контакта",
                            content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE,
                                    schemaProperties = {
                                            @SchemaProperty(name = "number",schema = @Schema(example = "89841519170")),
                                            @SchemaProperty(name = "name",schema = @Schema(example = "Maksim")),
                                            @SchemaProperty(name = "surname",schema = @Schema(example = "Kuppa"))})),
